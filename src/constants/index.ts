  ...
  public static readonly SELECTOR_CONSTANTS = {
    ...
    LISTINGS_CONSTANTS: {
      ...
      FLEA_ASSIST_BUTTON_PREVIOUS:
        '#currentListing > div.merList.border__17a1e07b.separator__17a1e07b > div:nth-child(',
      /**
    ...
    TODOS_CONSTANTS: {
      ...
      /** 商品画像 */
      THUMBNAIL:
        'div.content__884ec505 > a > div > div > div.merItemThumbnail.small__a6f874a2.image__8ccd0d74 > figure > div.imageContainer__f8ddf3a2',
    },
  };

  public static readonly COMMON_CONSTANTS = {
    GREATER_THAN: ' > ',
  };
}
